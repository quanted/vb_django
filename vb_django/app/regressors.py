...
class LinRegSupreme(BaseEstimator, RegressorMixin, BaseHelper):
    ...
    def __init__(self, pipeline_id=None, do_prep='True', prep_dict={'impute_strategy': 'impute_knn5'}, gridpoints=4,
                 inner_cv=None, groupcount=None, impute_strategy=None, bestT=False, cat_idx=None, float_idx=None,
