"""
Django settings for vb_django project.
...
WSGI_APPLICATION = 'vb_django.wsgi.application'
...
STATIC_ROOT = os.path.join("/opt", "collected_static", "vb")
STATICFILES_DIRS = (
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'vb_django.authentication.ExpiringTokenAuthentication'
    )
}
